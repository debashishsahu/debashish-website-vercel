...
const socialLinks = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/debashishsahu/',
    icon: (
  ...
  {
    label: 'Behance',
    href: 'https://www.behance.net/debashishsahu',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/_travellingmonk/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="max-w-content mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            ...
            <div className="flex-1 max-w-[520px]">
              ...
              <h2 className="font-display text-[clamp(1.625rem,7vw,2.5rem)] font-medium text-ink tracking-tight leading-[1.08] mb-5">
                Let&apos;s make something great together.
              </h2>
              <p className="text-16 font-light text-slate leading-[1.7] mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <motion.a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-amber-bright text-[#1A2530] text-13 font-medium px-6 py-3 rounded-md"
                >
                  Say hello
            ...
            <div className="flex flex-col gap-6 lg:items-end shrink-0">
              <div className="flex gap-3">
                {socialLinks.map((s) => (
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label={s.label}
                    className="w-10 h-10 flex items-center justify-center text-[#E4DBCC] border border-[#E4DBCC]/30 bg-[#E4DBCC]/[0.10] rounded-lg hover:bg-[#E4DBCC]/20 hover:text-white transition-colors"
                  >
                    {s.icon}
                  </a>
                ))}
              ...
              <div className="lg:text-right">
                <p className="text-13 font-medium text-ink">Debashish Sahu</p>
          ...
          <nav aria-label="Footer navigation" className="flex gap-5">
            {footerNav.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-12 text-mist hover:text-ink transition-colors"
              >
                {link.label}
              </Link>
            ))}
